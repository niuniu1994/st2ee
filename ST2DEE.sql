...
insert into tutor(t_name, username, password)
values ('JAMES', 'james', 0000),
       ('LUC', 'luc', 0000);
insert into student(first_name, last_name, student_group, company_name, charger, address, t_id)
values ('TAYLOR', 'SWIFT', 'L3', 'UNIVERSAL MUSIC', 'BEYONCE', '1 ROAD OF USA', 1),
